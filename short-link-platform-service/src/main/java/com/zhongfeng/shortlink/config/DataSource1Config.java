...
import com.zhongfeng.sms.persistence.sharding.ShardingAlgorithmMobile50;
...
@Configuration
@MapperScan(basePackages = {"com.zhongfeng.sms.persistence.mapper","com.zhongfeng.sms.persistence.mobile.mapper"}, sqlSessionTemplateRef = "db1SqlSessionTemplate")
...
//        shardingRuleConfiguration.getTableRuleConfigs().add(getOrderTableRuleConfiguration1());
//        shardingRuleConfiguration.getTableRuleConfigs().add(getOrderTableRuleConfiguration2());
    ...
    private TableRuleConfiguration getOrderTableRuleConfiguration() {
        ...
        //逻辑表名称
        rule.setLogicTable("t_plat_mobile_model");
        // 表分片策略
        StandardShardingStrategyConfiguration strategyConfiguration =
                new StandardShardingStrategyConfiguration("mobile_no", new ShardingAlgorithmMobile50());
...
//    private TableRuleConfiguration getOrderTableRuleConfiguration1() {
//        TableRuleConfiguration rule = new TableRuleConfiguration();
//        //逻辑表名称
//        rule.setLogicTable("t_plat_complaint_black_mobile");
//        // 表分片策略
//        StandardShardingStrategyConfiguration strategyConfiguration =
//                new StandardShardingStrategyConfiguration("mobile_no", new ShardingAlgorithmMobile());
//        rule.setTableShardingStrategyConfig(strategyConfiguration);
...
//    private TableRuleConfiguration getOrderTableRuleConfiguration2() {
//        TableRuleConfiguration rule = new TableRuleConfiguration();
//        //逻辑表名称
//        rule.setLogicTable("t_plat_vacant_mobile");
//        // 表分片策略
//        StandardShardingStrategyConfiguration strategyConfiguration =
//                new StandardShardingStrategyConfiguration("mobile_no", new ShardingAlgorithmMobile());
//        rule.setTableShardingStrategyConfig(strategyConfiguration);
